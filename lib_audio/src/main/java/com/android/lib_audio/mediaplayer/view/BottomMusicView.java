...
import com.android.lib_commin_ui.circle_image_view.CircleImageView;
...
public class BottomMusicView extends RelativeLayout  {
    ...
    private static final String TAG = "BottomMusicView";
