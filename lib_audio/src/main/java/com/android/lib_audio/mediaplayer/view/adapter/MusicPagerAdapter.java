package com.android.lib_audio.mediaplayer.view.adapter;
...
//    private SparseArray<ObjectAnimator> mAnims = new SparseArray<>(); //动画缓存
//    private Callback mCallback;
//
//    public MusicPagerAdapter(Context mContext, ArrayList<AudioBean> mAudioBeans, Callback mCallback) {
...
//        View rootView= LayoutInflater.from(mContext).inflate(R.layout.indictor_item_view,null); //加载item视图
//        ImageView imageView=rootView.findViewById(R.id.circle_view);
//        container.addView(rootView);
//        ImageLoaderManager.getInstance().
//                displayImageForCircle(imageView,mAudioBeans.get(position).albumPic);  //加载圆形图片
//        //无动画时创建并缓存
